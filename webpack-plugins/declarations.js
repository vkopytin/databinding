        ...
        compiler.hooks.emit.tapAsync('DeclarationBundlerPlugin', function (compilation, callback) {
            ...
            compilation.chunks.forEach(function (chunk) {
                ...
                chunk.forEachModule(function (module) {
                    ...
                    module.buildInfo.fileDependencies.forEach(function (filepath, a, b, c) {
                        // we've learned a lot about the source structure now...
                        const fileRelativePath = path.relative('', filepath);
                        if (/^src/.test(fileRelativePath)) {
                            files.push('../' + fileRelativePath.replace(/\.ts$/, '.d.ts'));
                        }
                    });
                });
            });
